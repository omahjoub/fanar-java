...
- Known-failing cases for the standard key — **11 per run**: 10 gated by design, plus one
  `LivePoemsTest` case that overran the 3× verse-miss tolerance on 2026-09-15 (see Poems above;
  whether the budget rises or the case joins this list is parked until the upgraded key lands,
  `PROJECT_STATE.md`). The 10 gated ones, counted from the code:
